...
namespace nuc {
    ...
    public:
        ...
        /**
         * Constructs a pathname with a given path string.
         *
         * @param path The path string.
         */
        pathname(string path);
        pathname(const char * path) : m_path(path) {}

        /**
         * Constructs a pathname with a given string.
         *
         * @param path The path string.
         *
         * @param is_dir True if the path represents a directory and
         *   should have a trailing slash added to it.
         */
        pathname(string path, bool is_dir);

        /**
         * Constructs a pathname from an array of path components.
         *
         ...
         *   should have a trailing slash added to it.
         */
        pathname(const std::vector<string> &components, bool is_dir = false);
         ...
         */
        static size_t subpath_offset(const std::set<pathname> &paths, const pathname &path);
    ...
    private:
        ...
        /**
         * Appends a component to the path string ensuring that there
         * is a seperating '/' between the path and the component.
         *
         * @param component The component.
         */
        void append_component(const string &component);
    };
...
namespace std {
    template <> struct hash<nuc::pathname> {
        size_t operator()(const nuc::pathname &path) const {
            return hash<nuc::pathname::string>()(path);
        }
    };
}
