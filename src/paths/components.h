...
#ifndef NUC_PATHS_COMPONENTS_H
#define NUC_PATHS_COMPONENTS_H
    ...
    namespace paths {
        ...
        public:
            ...
            public:
                 ...
                 */
                iter(const string &path, size_t pos);
                 ...
                 */
                bool last() const {
                    return next_non_slash() == string::npos;
                }
             ...
             */
            path_components(const string &path) : path(path) {}

            /**
             * Returns an array of all path components in the path string.
             */
            static std::vector<string> all(const string &path);
